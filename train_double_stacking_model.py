...
def encoding(x, loadPath=None):
	with tf.variable_scope(name_or_scope="E") as scope:
		weights = {
			'ew': tf.get_variable(name='wo', shape=[32 * 40 * 12, 100], dtype=tf.float32,initializer=tf.random_normal_initializer(mean=0.0, stddev=0.01))
		}
	...
	midFeat = tf.reshape(midFeat, shape=[-1, 32 * 40 * 12])
...
# load
	...
	filters = [[enc1_f1, enc1_f2, enc1_f3, enc1_f4], [enc2_f1, enc2_f2, enc2_f3]]
	bias    = [[enc1_b1, enc1_b2, enc1_b3, enc1_b4], [enc2_b1, enc2_b2, enc2_b3]]


	# binary sample for code
	#ncode = tf.math.l2_normalize(code,axis=1)
	...
	model = [wo, enc1_f1, enc1_f2, enc1_f3, enc1_f4, enc1_b1, enc1_b2, enc1_b3, enc1_b4, enc2_f1, enc2_f2, enc2_f3, enc2_b1, enc2_b2, enc2_b3]
